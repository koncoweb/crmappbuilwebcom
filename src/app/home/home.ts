...
export default class Home extends LitElement {
  ...
  constructor() {
    ...
    this.northwindCustomers = this.northwindService.getData('CustomersType');
    this.cRMAppDataService.getMeetingsTasks().then((data) => {
  ...
  private cRMAppDataService: CRMAppDataService = new CRMAppDataService();
      ...
      <div class="row-layout group">
        <div class="column-layout group_1">
          <div class="column-layout group_2">
            ...
            <a href="" @click="${() => Router.go('/reports')}" class="typography__body-2 hyperlink">
              View All Reports
            </a>
          </div>
          <div class="column-layout group_3">
            ...
            <a href="" @click="${() => Router.go('/contracts')}" class="typography__body-2 hyperlink">
              View All Contracts
            </a>
          </div>
        </div>
        <div class="column-layout group_4">
          <div class="column-layout group_5">
                  ...
                  <igc-list-item>
                    ...
                    <div>
                      <div class="column-layout group_7">
                        <a href="" @click="${() => Router.go('/account-sample')}" class="typography__body-2 hyperlink_1">
                          ${item.companyName}
                        </a>
            ...
            <a href="" @click="${() => Router.go('/accounts')}" class="typography__body-2 hyperlink">
              View All Accounts 
            </a>
          </div>
          <div class="column-layout group_5">
              ...
              <igc-list class="list">
                ${this.northwindCustomers?.map((item) => html`
                  <igc-list-item>
                    ...
                    <div>
                      <div class="column-layout group_7">
                        <a href="" class="typography__body-2 hyperlink_2">
                          ${item.contactName}
                        </a>
                        <div class="row-layout group_9">
                          ...
                          <a href="" class="typography__caption hyperlink_3">
                            ${item.companyName}
                          </a>
                        </div>
                      </div>
            ...
            <a href="" @click="${() => Router.go('/contacts')}" class="typography__body-2 hyperlink">
              View All Contacts 
            </a>
          </div>
        </div>
        <div class="column-layout group_4">
          <div class="column-layout group_3">
            ...
            <a href="" @click="${() => Router.go('/calendar')}" class="typography__body-2 hyperlink">
              View Calendar
            </a>
          </div>
          <div class="column-layout group_3">
            ...
            <a href="" @click="${() => Router.go('/tasks')}" class="typography__body-2 hyperlink">
              View Tasks
            </a>
          </div>
        </div>
