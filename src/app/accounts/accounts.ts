    ...
    return html`
          ...
          <div class="column-layout group_2">
            <div class="row-layout header">
              ...
              <div class="row-layout buttons">
                <igc-button variant="flat" @click=${() => this.newAccountDialog?.toggle()} class="button button_2">
                ...
                <igc-button variant="flat" class="button button_3">
                  <span class="material-icons">
                    search
                  </span>
                ...
                <igc-button variant="flat" class="button button_4">
                  <span class="material-icons">
                    import_export
                  </span>
                  <span>Import</span>
            ...
            <div class="row-layout filters-and-sorting">
              <div class="row-layout group_4">
                <igc-select ?outlined="${false}" .value="${this.value}" class="select">
              ...
              <div class="row-layout group_5">
                <igc-button variant="flat" @click=${() => this.dropdown?.toggle(this.button)} id="button" class="button button_5">
      ...
      <igc-dialog ?close-on-outside-click="${true}" ?keep-open-on-escape="${false}" id="new-account-dialog">
            ...
            <div class="column-layout group_8">
              ...
              <div class="row-layout group_9">
                <div class="column-layout group_10">
                  ...
                  <igc-select ?outlined="${false}" label="Type" .value="${this.value1}" class="user-input">
                    <igc-select-item value="1">
                      -- None --
                    </igc-select-item>
                    <igc-select-item value="2">
                ...
                <div class="column-layout group_10">
                  ...
                  <igc-select ?outlined="${false}" label="Industry" .value="${this.value1}" class="user-input">
                    <igc-select-item value="1">
                      -- None --
                    </igc-select-item>
                    <igc-select-item value="2">
            ...
            <div class="row-layout group_12">
              <div class="column-layout group_10">
                ...
                <div class="row-layout group_13">
                  ...
                  <igc-select ?outlined="${false}" label="Country" .value="${this.value1}" class="user-input_2">
                    <igc-select-item value="2">
                      Country 1
                    </igc-select-item>
                    <igc-select-item value="2">
        ...
        <div slot="footer">
          ...
          <igc-button @click=${() => this.newAccountDialog?.toggle()} class="button_1 button_1_1">
            Save
            <igc-ripple></igc-ripple>
          </igc-button>
        </div>
